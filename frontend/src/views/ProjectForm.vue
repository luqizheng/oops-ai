<template>
  <div class="space-y-8 p-4 max-w-4xl mx-auto">
    ...
    <div
      class="bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-100 p-8"
    >
      <div class="flex items-center space-x-3 mb-8">
        <div
          class="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-100"
        >
      ...
      >
        ...
        <div
          class="pt-8 border-t border-gray-50 flex items-center justify-end gap-4"
        >
          <el-button
            @click="router.back()"
            class="!rounded-xl px-8 !h-11 !font-bold"
          >
            取消
          </el-button>
          <el-button
