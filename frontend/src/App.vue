        ...
        >
          <div class="flex items-center space-x-3">
            ...
            <div class="flex flex-col">
              ...
              <span
                class="text-[10px] text-indigo-300/80 uppercase font-semibold tracking-wider"
                >需求智能体</span
              >
            </div>
          </div>
          ...
          <div class="h-full px-6 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
              ...
              <el-dropdown @command="handleDropdownCommand">
                <span
                  class="el-dropdown-link cursor-pointer outline-none hover:opacity-80 transition-opacity"
                >
                  <div
                  ...
                  >
                    ...
                    >
                    <el-icon
                      class="el-icon--right text-gray-500 dark:text-gray-400"
                      ><ArrowDown
                    /></el-icon>
                  </div>
                </span>
