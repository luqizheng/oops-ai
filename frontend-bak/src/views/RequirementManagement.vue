        ...
        >
          <div class="flex justify-between items-start mb-4 shrink-0">
            <div class="flex-1 min-w-0">
              <h3
                class="font-black text-xl text-slate-900 leading-tight group-hover:text-indigo-600 transition-colors truncate pr-4"
              >
                {{ requirement.title }}
              </h3>
            </div>
            <div
              class="flex gap-1 shrink-0 px-2 py-1 bg-slate-50 rounded-lg group-hover:bg-indigo-50 transition-colors"
            >
              <el-button
          ...
          <div class="mb-8 h-12">
            <p
              class="text-sm text-slate-500 line-clamp-2 leading-relaxed font-medium"
            >
              {{
                requirement.description ||
                "该需求暂无详细说明。完善描述有助于 AI 更精准地进行分析并生成高质量的用户故事。"
              }}
            </p>
          </div>
          ...
          <div class="flex flex-col gap-4">
            <div
              v-if="requirement.qualityScore"
              class="bg-slate-50 group-hover:bg-white rounded-2xl p-4 border border-transparent group-hover:border-slate-100 transition-all"
            >
              <div class="flex justify-between items-center mb-2">
                ...
                <span
                  ...
                  :class="getScoreColor(requirement.qualityScore.totalScore)"
                >
              ...
              <el-progress
                ...
                :stroke-width="6"
                :color="
                  getScoreProgressColor(requirement.qualityScore.totalScore)
                "
            ...
            <div
              v-else
              class="bg-slate-50 rounded-2xl p-4 border border-dashed border-slate-200 text-center"
            >
            ...
            <div
              class="flex items-center justify-between mt-2 pt-4 border-t border-slate-50 shrink-0"
            >
              <span class="text-[11px] font-bold text-slate-300 italic">{{
