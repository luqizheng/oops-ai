    ...
    >
      ...
      >
        ...
        >
          <!-- 彩色装饰条 -->
          <div
            class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-indigo-400 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity"
          ></div>
          ...
          <div class="space-y-4">
            ...
            >
              <div
                class="flex items-center text-[11px] text-gray-400 font-medium tracking-tight"
              >
              ...
              <el-tag
                size="small"
                effect="plain"
                class="!border-indigo-100 !text-indigo-400 uppercase text-[10px] font-bold"
              >
                Standard
              </el-tag>
            </div>
...
import { ElButton, ElTooltip, ElEmpty, ElIcon, ElTag } from "element-plus";
import {
  Plus,
  Edit,
  Delete,
